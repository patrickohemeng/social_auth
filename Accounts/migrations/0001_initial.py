...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'Accounts_userprofile', (
            ...
            ('phonenumber', self.gf('django.db.models.fields.CharField')(default='+233', max_length=20)),
    ...
    models = {
        u'Accounts.userprofile': {
            ...
            'phonenumber': ('django.db.models.fields.CharField', [], {'default': "'+233'", 'max_length': '20'}),
